...
export const metadata: Metadata = {
  ...
  description: `Read about how we collect, store, and manage data at Anand & Associates, chartered accountants, and our secure file exchange protocols.`,
};
    ...
    <div className="bg-cream py-16 sm:py-24 font-sans animate-fade-in">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-10 rounded-r-lg text-amber-900 text-sm">
          ...
          <p>
            <strong>⚠️ Developer Notice:</strong> This privacy policy is a draft generated for demonstration and staging purposes only. It must be reviewed and adjusted by a qualified legal professional prior to launching the site to real visitors.
          </p>
        </div>
